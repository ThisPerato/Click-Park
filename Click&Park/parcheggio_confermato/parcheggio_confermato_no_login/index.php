    ...
    <body>
        ...
        <div id="how-it-works-popup" class="popup">
            <div class="popup-content">
                ...
                <p>Se sei in questa pagina significa che tutto è andato bene, la tua prenotazione è stata
                    effettuata con successo! In fondo alla pagina troverai tutti i dati riguardo alla prenotazione. Ti
                    consigliamo di fare uno screenshot se vuoi averli a disposizione oppure di iscriverti al sito in
                    modo di avere sempre le tue prenotazioni a disposizione nella tua pagina profilo!</p>
